 ...
 * @author vishv
 */
public class DlgPrintSaveReport extends javax.swing.JDialog {
    
    private DialogActions action;

    /**
     * Creates new form DlgPrintSaveReport
     */
    public DlgPrintSaveReport(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        lblTitle.setText("Action Required");
        ...
        lblMessage.setText("<HTML>Save or print the report</HTML>");
